        ...
        <>
            ...
            <div id="home" className="container mx-auto md:mt-28 mt-20 px-6 text-white min-h-[1000px]">
                ...
                <div className="my-48 text-white relative">
                    ...
                    <h3 className="text-center md:text-5xl text-3xl font-semibold mb-14">Our Expertise</h3>
...
const ExpertiseCard = () => {
    return (
        <div className="backdrop-filter backdrop-blur-lg bg-dark2 bg-opacity-10 text-center border border-purple/30 rounded-lg py-5 px-5">
    ...
    return (
        <div className="mb-5 w-full cursor-pointer">
            <div className={"transition-all duration-300 hover:text-purple " + (y > 800 ? 'scale-100' : 'scale-0')}>
                ...
                <h6 className="text-2xl">Bagaimana Cara Beli Mobile Legends?</h6>
            </div>
...
const StakeCard = () => {
    const [y, setY] = useOutletContext()
    return (
        <div className={"transition-all duration-300 mb-3 text-center border rounded-tr-2xl rounded-bl-2xl border-gray-700 " + (y > 1400 ? 'scale-100' : 'scale-0')}>
            ...
            <div className="bg-purple/5 rounded-bl-2xl pb-5 pt-2 border-t border-gray-700">
                <h6 className="text-lg mb-1">Agoric{y}</h6>
